...
const frequencyRanges = [
    ...
    { min: 136.00, max: 174.00 }, // VHF band
    { min: 216.00, max: 222.00 }, // Additional VHF range
    { min: 300.00, max: 420.00 }, // UHF range 1
    { min: 420.00, max: 450.00 }, // Amateur radio UHF
    { min: 450.00, max: 470.00 }, // Original range (approximately)
    { min: 470.00, max: 512.00 }, // UHF upper range 
    { min: 764.00, max: 870.00 }, // Public safety band
    { min: 902.00, max: 928.00 }  // ISM band
];
